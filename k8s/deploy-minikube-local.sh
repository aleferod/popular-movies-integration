kubectl -n popular-movies-integration rollout restart deployment popular-movies-integration-app
kubectl apply -f ./
aws --endpoint-url=http://192.168.49.2:32622 sqs create-queue --queue-name rate-movie
